package helllo.upload.controller;


import helllo.upload.domain.Item;
import helllo.upload.domain.ItemRepository;
import helllo.upload.domain.UploadFile;
import helllo.upload.file.FileStore;
...
public class ItemController {
    ...
    public String newItem(@ModelAttribute(value = "form") ItemForm form){
        return "item-form";
    }

    @PostMapping("/items/new")
    public String saveItem(@ModelAttribute(value = "form") ItemForm form, RedirectAttributes redirectAttributes) throws IOException {
